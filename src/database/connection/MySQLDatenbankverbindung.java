...
public class MySQLDatenbankverbindung extends AllgemeineDatenbankverbindung {
     ...
     *
     * @param server   MySQL-Server zu dem eine Datenbankverbindung aufgebaut werden soll
     ...
     */
    public MySQLDatenbankverbindung(String server, int port, String database, String user, String passwd) {
    ...
    public boolean connect() {
        if (con == null) {
            ...
            try {
                ...
                con = DriverManager.getConnection("jdbc:mysql://" + SERVER + ":" + PORT + "/" + DATABASE, USER, PASSWD);

                // AutoCommit auf false setzen
                con.setAutoCommit(false);

            } catch (ClassNotFoundException e) {
                throw new IllegalArgumentException("Der JDBC-Treiber für MySQL konnte nicht gefunden werden!");
