...
public class MSSQLDatenbankverbindung extends AllgemeineDatenbankverbindung {
     ...
     *
     * @param server   MSSQL-Server zu dem eine Datenbankverbindung aufgebaut werden soll
     ...
     */
    public MSSQLDatenbankverbindung(String server, int port, String database, String user, String passwd) {
    ...
    public boolean connect() {
        if (con == null) {
            ...
            try {
                ...
                con = DriverManager.getConnection("sqlserver://" + SERVER + ":" + PORT + "\\" + DATABASE, USER, PASSWD);

                // AutoCommit auf false setzen
                con.setAutoCommit(false);

            } catch (ClassNotFoundException e) {
                throw new IllegalArgumentException("Der JDBC-Treiber für MS-SQL konnte nicht gefunden werden!");
